  ...
  <div>
    ...
    <transition name="fade">
      <div
        ...
        v-show="this.isShowLocationPreview['saudi']"
      >
        <div
          class="previewSelectionImageArea"
          :style="{
            backgroundImage: `url('${locationSelectionImage['saudi']}')`,
          }"
        ></div>
    ...
    <transition name="fade">
      <div
        ...
        class="previewSelection"
        v-show="this.isShowLocationPreview['hk']"
      >
        <div
          class="previewSelectionImageArea"
...
export default {
    ...
    $(function () {
      ...
      $("#a-scene").bind({
        ...
        "touchmove mousemove": function (e) {
          ...
          //e.preventDefault();
          var x =
            (isTouch ? event.changedTouches[0].pageX : e.pageX) - clickPosX;
          var y =
            (isTouch ? event.changedTouches[0].pageY : e.pageY) - clickPosY;
  ...
  methods: {
    ...
    gridOneTimeAnimation() {
      let self = this;
      if (
        document.getElementById("gridUpModel") == null ||
        document.getElementById("gridDownModel") == null
      ) {
        setTimeout(function () {
          self.gridOneTimeAnimation();
        }, 100);
      } else {
        console.log("grid animation");
        document
          .getElementById("gridUp")
          .setAttribute(
            "animation",
            "property: scale; from: 0 0 0;to: 5 2 5; dur: 2000; easing: linear; loop: false"
          );
        document
          .getElementById("gridUpModel")
          .setAttribute(
            "animation",
            "property: model-opacity; from: 0;to: 0.7.; dur: 2000; easing: linear; loop: false"
          );
        document
          .getElementById("gridDown")
          .setAttribute(
            "animation",
            "property: scale; from: 0 0 0;to: 5 2 5; dur: 2000; easing: linear; loop: false"
          );
        document
          .getElementById("gridDownModel")
          .setAttribute(
            "animation",
            "property: model-opacity; from: 0;to: 0.7; dur: 2000; easing: linear; loop: false"
          );
    ...
    searchMenuSlideIn() {
      ...
      if (document.getElementById("searhMenuArea") == null) {
        setTimeout(function () {
          self.searchMenuSlideIn();
        }, 100);
      } else {
        console.log("@@@@@@@");
        document
          .getElementById("searhMenuArea")
          .classList.add("searhMenuSlideIn");
      }
    },
    ...
    earthButtonAnimation() {
      let self = this;
      if (
        document.getElementById("gridButtonSaudi") == null ||
        document.getElementById("gridButtonHongKong") == null
      ) {
        setTimeout(function () {
          self.earthButtonAnimation();
        }, 100);
      } else {
        document
          .getElementById("gridButtonSaudi")
          .setAttribute(
            "animation",
            "property: model-opacity; from:0.5 ; to: 1; dir: alternate; dur: 1000; easing: linear; loop: true"
          );
        document
          .getElementById("gridButtonHongKong")
          .setAttribute(
            "animation",
            "property: model-opacity; from:0.5 ; to: 1; dir: alternate; dur: 1000; easing: linear; loop: true"
          );
    ...
    earthRotateAnimation() {
      ...
      if (document.getElementById("earthModel") == null) {
        setTimeout(function () {
          self.earthRotateAnimation();
        }, 100);
      } else {
        document
          .getElementById("earthModel")
          .setAttribute(
            "animation",
            "property: rotation; to: 0 -360 0; dur: 35000; easing: linear; loop: true ; pauseEvents: pause; resumeEvents: resume;"
          );
      }
    },
    ...
    earthMoveOneTimeAnimation() {
      ...
      if (document.getElementById("earthParent") == null) {
        setTimeout(function () {
          self.earthMoveOneTimeAnimation();
        }, 100);
      } else {
        document
          .getElementById("earthParent")
          .setAttribute(
            "animation",
            "property: position; from: 0 -0.5 1; to: 0 0 1; dur: 1000; easing: linear; loop: false"
          );
      }
    },
    ...
    earthLightMoveOneTimeAnimation() {
      ...
      if (document.getElementById("earthLight") == null) {
        setTimeout(function () {
          self.earthLightMoveOneTimeAnimation();
        }, 100);
      } else {
        document
          .getElementById("earthLight")
          .setAttribute(
            "animation",
            "property: position; from: 0 -0.5 -1; to: 0 0 -1; dur: 1000; easing: linear; loop: false"
          );
    ...
    rotateToLocation(destination) {
      ...
      if (destination == "hongkong") {
        document
          ...
          .setAttribute(
            "animation",
            "property: rotation; to: -15.915352707059796 -4.32 -0.09535382862672112; dur: 1000; easing: linear; loop: false"
          );
        ...
        document
          ...
          .setAttribute(
            "animation",
            "property: rotation; to: -7.808419537927654 -80.19000000000011 9.495539192944605; dur: 1000; easing: linear; loop: false"
          );
        ...
        document
          ...
          .setAttribute(
            "animation",
            "property: rotation; to: -12.68570050071176 79.65000000000008 23.464355455717577; dur: 1000; easing: linear; loop: false"
          );
      }
    ...
    removeAllPreview() {
      for (
        var loop = 0;
        loop < this.isShowLocationPreviewArray.length;
        loop++
      ) {
        this.isShowLocationPreview[
          this.isShowLocationPreviewArray[loop]
        ] = false;
      }
      for (
        var loop = 0;
        loop < this.isShowSatellitePreviewArray.length;
        loop++
      ) {
        this.isShowSatellitePreview[
          this.isShowSatellitePreviewArray[loop]
        ] = false;
      }
    },
  },
  ...
  computed: {
    ...
    checkIsEnableGridFunction() {
      return store.state.isEnableGridFunction;
    },
    checkRemoveAllPreviewEvent() {
      return store.state.removeAllPreviewEvent;
    },
  },
  watch: {
    ...
    checkIsEnableGridFunction(flag) {
      if (flag) {
        ...
        document
          .getElementById("earthModel")
          .setAttribute("material", "src:#earthTextureWithGrid;");
        document
          .getElementById("gridButtonSaudi")
        ...
        document
          .getElementById("earthModel")
          .setAttribute("material", "src:#earthTexture;");
        document
          .getElementById("gridButtonSaudi")
