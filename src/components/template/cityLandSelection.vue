  ...
  methods: {
    ...
    selectData(data) {
      ...
      if (store.state.leftMenuSelectingArea != "") {
        if (
          store.state.areaDictionary[store.state.leftMenuSelectingArea]
            .cesiumData[data] != null
        ) {
          console.log(
            "display data " +
              store.state.areaDictionary[store.state.leftMenuSelectingArea]
...
// WEBPACK FOOTER // // src/components/template/cityLandSelection.vue
