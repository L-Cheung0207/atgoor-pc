<template>
  <div>
    <transition name="fade">
      <div v-show="selectingArea == ''" class="leftMenuContainerArea touch">
        <!-- 按 tab 分 陸地 和 海洋 -->
        <div class="leftMenuTabArea">
          ...
          >
            <div id="landTabTitle" class="tabTitleArea tabTitleAreaSelecting">
              <div class="tabTitleIconArea">
                <img class="tabTitleIcon" :src="tabIcon['land']" />
              </div>
          ...
          >
            <div id="oceanTabTitle" class="tabTitleArea">
              <div class="tabTitleIconArea">
                <img class="tabTitleIcon" :src="tabIcon['ocean']" />
              </div>
              <div class="tabTitleTextArea">
    ...
    <transition name="fade">
      ...
      >
        <div class="displaySelectedAreaArea">
          ...
          >
            <img class="displaySelectedAreaBackButton" :src="backButtonImage" />
          </div>
        </div>
        ...
        <div class="landSetectionArea">
          <div class="landSetectionSubArea">
            <div class="landSetection">
              ...
              >
                <img class="landSelectionImage" :src="landImage['cityLand']" />
              </div>
              <div
              ...
              <div class="landSelectionTextArea">
                <div class="landSelectionText" v-html="$t('cityLand')" />
              </div>
            </div>
            <div class="landSetection">
              <div
            ...
            <div class="landSetection">
              ...
              <div class="landSelectionTextArea">
                <div class="landSelectionText" v-html="$t('forestRights')" />
              </div>
            </div>
            <div class="landSetection">
              <div
              ...
              <div class="landSelectionTextArea">
                <div class="landSelectionText" v-html="$t('freshWater')" />
              </div>
            </div>
          </div>
        </div>
...
export default {
  ...
  computed: {
    ...
    checkLeftMenuSelectingCountry() {
      return store.state.leftMenuSelectingCountry;
    },
    checkLeftMenuSelectingArea() {
      return store.state.leftMenuSelectingArea;
    },
    checkLeftMenuSelectingLand() {
      return store.state.leftMenuSelectingLand;
    },
  },
  watch: {
    ...
    checkLeftMenuSelectingCountry(country) {
      ...
      if (country != "") {
        this.selectingCountryName =
          store.state.countryDictionary[country].countryName;
        this.selectingCountryImage =
          store.state.countryDictionary[country].countryImage;
      } else {
        this.selectingCountryName = "";
        this.selectingCountryImage = "";
      }
  ...
  methods: {
    selectTab(tab) {
      ...
      for (var loop = 0; loop < this.tabArray.length; loop++) {
        document
          .getElementById(this.tabButtonId[this.tabArray[loop]])
          .classList.remove("leftMenuTabSelecting");
        document
          .getElementById(this.tabTitleId[this.tabArray[loop]])
          .classList.remove("tabTitleAreaSelecting");
      }
      document
        .getElementById(this.tabButtonId[tab])
        .classList.add("leftMenuTabSelecting");
      document
        .getElementById(this.tabTitleId[tab])
        .classList.add("tabTitleAreaSelecting");
    },
    ...
    setupCountryList() {
      ...
      if (document.getElementById("landTabCountrySelectionArea") == null) {
        ...
        for (
          var setupCountryLoop = 0;
          setupCountryLoop < this.countrySelectionJsonData.length;
          setupCountryLoop++
        ) {
          console.log("setup country " + setupCountryLoop);
          let countryId = this.countrySelectionJsonData[setupCountryLoop]["id"];
          let countryName =
            this.countrySelectionJsonData[setupCountryLoop]["name"];
          let countryLocalImage =
            this.countrySelectionJsonData[setupCountryLoop]["localImageUrl"];
          let countryUnlock =
            this.countrySelectionJsonData[setupCountryLoop]["unlock"];

          let newCountryDictionary = {
            countryName: countryName,
            countryImage: "static/images/countrySelection/" + countryLocalImage,
          };
          ...
          newCountry.$mount();
          document
            .getElementById("landTabCountrySelectionArea")
            .appendChild(newCountry.$el);
        }
      }
    },
    ...
    setupAreaList() {
      ...
      if (document.getElementById("landTabSubSelectionArea") == null) {
        ...
        for (
          ...
          newArea.$mount();
          document
            .getElementById("landTabSubSelectionArea")
            .appendChild(newArea.$el);
        }
      }
    },
...
// WEBPACK FOOTER // // src/components/leftMenu.vue
